...
さて、今回のお題は前回ギブアップした、Google Speech APIを使用した、 +
...
image::https://raw.githubusercontent.com/innovation-jp/innovation-jp.github.io/master/images/tsukamoto/googleApi.png[]
